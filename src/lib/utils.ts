...
export const pagination = (listClass: any, sort: any, active: any) => {
...
export const getPagination = (totalNumber: any, sort: any) => {
...
export const activeNavMenu = () => {
  const navItem: NodeListOf<HTMLAnchorElement> = document.querySelectorAll(".main-menu li a");
